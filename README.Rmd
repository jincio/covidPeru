...
head(fallecidos)
```
Cargamos el último set disponible en el portal de datos abiertos de vacunados contra COVID-19.

```{r vacunados1, eval=FALSE}
vacunados=da_vacunados() # Crea un dataframe con la información de fallecidos.
```
